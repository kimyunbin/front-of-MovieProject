<template>
  ...
  <article class="ink_atc round20 has_list ">
		...
		<header class="atc_header">
			<h1>
				<a href="https://extmovie.com/movietalk/65603779" class="atc_title">《크루엘라》한국화 포스터 인증한 엠마 스톤 &amp; 엠마 톰슨</a>
			</h1>
			<div class="atc_info clearfix">
				<span class="atc_nickname">
				<span class="inkpf color round small"><img class="inkpf_img" src="//img.extmovie.com/files/member_extra_info/profile_image/247/982/042/42982247.jpg?20190130002956" alt="아지뱀"></span>								<a href="#popup_menu_area" class="member_42982247" onclick="return false"><img src="https://extmovie.com/modules/point/icons/xeicon_coa/18.gif" alt="[레벨:18]" title="포인트:32420point (97%), 레벨:18/99" class="xe_point_level_icon" style="vertical-align:middle;margin-right:3px;">아지뱀</a>			</span>
				<span class="text_en atc_date font_grey1"><time datetime="2021-05-22T18:05:58+09:00">2021.05.22. 18:05</time></span>
				<div class="atc_info_right text_en font_grey1">
					<span class="count_read"><i class="fas fa-eye" title="조회 수"></i> 6282</span>				
					<span class="count_vote pt_col"><i class="fas fa-heart" title="추천 수"></i> 79</span>				
					<span class="count_cmt pt_col2"><i class="fas fa-comment-dots" tilte="댓글"></i> 36</span>
				</div>
			</div>
		</header>
		...
		<!-- 글 내용 부분 -->
			<div class="document_65603779_42982247 rhymix_content xe_content" data-pswp-uid="1">
				<p>
					<img src="//img.extmovie.com/files/attach/images/135/779/603/065/9772f08a8774d8d3c79713c6e5cc08ea.jpg" alt="disneykorea_20210522_180426_0.jpg" style="" data-pswp-pid="1">
				</p>
				<p>&nbsp;</p>
				<p>&nbsp;</p>
				<p>흑요석 예술가님이 그린 크루엘라 한국화 포스터 특전이나 리뷰 이벤트로 증정 했으면 좋겠네요</p>
			</div>
			...
			<div class="atc_buttons clearfix">
				...
				<div class="atc_vote">
						<button class="bt_vote vote_area" type="button" onclick="insertWarn('로그인 해주세요.')">좋아요<span class="voted_count text_en">79</span></button>
				</div>
			</div>
			...
			<div id="voted_who">
				<div class="atc_who bg_grey1 scroll_wrap show">
					<h3>추천인 <span class="text_en pt_col">83</span></h3>
					<div class="scroll-wrapper inner scrollbar-macosx" style="position: relative;"><div class="inner scrollbar-macosx scroll-content scroll-scrolly_visible" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 105px;">
						<ul class="scroll_x">
							<li>
								<span class="inkpf color round"></span><br><span class="vote_nickname">초코우유</span>
							</li>
							<li>
								<span class="inkpf color round">
									<img src="이미지주소" alt="닉네임" class="inkpf_img">
								</span>
								<br>
								<span class="vote_nickname">나초</span>
							</li>
